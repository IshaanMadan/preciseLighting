                    ...
                    if(shippMethods.length){
                        shippMethods.find('.radio').each(function(index, el) {
                            ...
                            if(codeValue.indexOf('storepickup') < 0){
                                ...
                                jQuery('[name="street[0]"]').attr('placeholder', 'Address Line 1');
                                jQuery('[name="street[1]"]').attr('placeholder', 'Address Line 2');
                                jQuery('[name="region"]').attr('placeholder', 'State/Province');
                                return false; 
                            }
                        });
                    }
