			...
			if( $stickyMenu.length > 0 ){
				...
				$(window).scroll(function(){
					...
					if(curWinTop > threshold){
						...
						$('.header-wrapper-content.sticky-menu.active').first().css({'margin-bottom':headerHeight+'px'});

					}else{

    					$('.header-wrapper-content.sticky-menu.active').first().css({'margin-bottom':'0px'});
