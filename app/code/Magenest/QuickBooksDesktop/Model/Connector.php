...
class Connector
{
    ...
    const CONFIG_BASE_URL = 'qbdesktop/qbd_setting/base_url';
    ...
    {
        $baseUrl =  $this->_scopeConfig->getValue(self::CONFIG_BASE_URL, \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
