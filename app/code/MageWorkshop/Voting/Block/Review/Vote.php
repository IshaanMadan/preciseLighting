...
class Vote extends \Magento\Framework\View\Element\Template
{
    ...
    {
        return (string) $this->escapeHtml($this->_scopeConfig->getValue(self::XML_PATH_VOTING_MESSAGE));
    }
    ...
    {
        return (string) $this->escapeHtml($this->_scopeConfig->getValue(self::XML_PATH_VOTING_HELPFUL_LABEL));
    }
    ...
    {
        return (string) $this->escapeHtml($this->_scopeConfig->getValue(self::XML_PATH_VOTING_UNHELPFUL_LABEL));
    }
    ...
    {
        return (string) $this->escapeHtml($this->_scopeConfig->getValue(self::XML_PATH_VOTING_ALERT_TITLE));
    }
    ...
    {
        return (int) $this->_scopeConfig->getValue(self::XML_PATH_VOTING_ALERT_TIMEOUT);
    }
}
