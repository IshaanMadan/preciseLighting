...
class Attribute extends \MageWorkshop\DetailedReview\Helper\AbstractAttribute
{
     ...
     * @param \MageWorkshop\DetailedReview\Helper\Media $mediaHelper
     ...
     * @throws \Exception
     */
    public function getReviewFormAttributesConfigurationByReview(Review $review, array $storeIds = [])
    {
     ...
     * @return array
     */
    protected function getValidationClassesArray($validationRules)
    {
        $validationClasses = [];
        ...
        foreach ($validationRules as $rule) {
            ...
            if (!in_array(self::VALIDATION_RULE_VALIDATE_LENGTH, $validationClasses)) {
    ...
    public function getReviewFormAttributes($product, array $storeIds = [])
    {
        ...
        if (!isset($this->attributeCollections[$cacheKey])) {
            ...
            foreach ($storeIds as $storeId) {
                ...
                // $sql = (string) $categoryCollection->getSelect();
