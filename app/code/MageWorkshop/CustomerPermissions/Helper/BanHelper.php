...
use MageWorkshop\CustomerPermissions\Model\ReviewBanFactory;
...
class BanHelper extends RulesHelper
{
    ...
    public function banByReviews(AbstractCollection $reviewCollection, $period)
    {
        ...
        $customersArray = $this->collectionFactory->create()->addAttributeToFilter('entity_id', array('in' => $customerIds))->getItems();
        foreach ($reviewCollection as $review) {
