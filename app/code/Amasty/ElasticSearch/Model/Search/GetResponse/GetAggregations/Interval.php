...
class Interval implements IntervalInterface
{
    ...
    public function load($limit, $offset = null, $lower = null, $upper = null)
    {
        ...
        return $this->convertToFloat($queryResult['hits']['hits'], $this->fieldName);
    }
    ...
    public function loadNext($data, $rightIndex, $upper = null)
    {
        ...
        return array_reverse($this->convertToFloat($queryResult['hits']['hits'], $this->fieldName));
    }
     ...
     * @return float[]
     */
    private function convertToFloat($hits, $fieldName)
    {
        $returnPrices = [];
        foreach ($hits as $hit) {
