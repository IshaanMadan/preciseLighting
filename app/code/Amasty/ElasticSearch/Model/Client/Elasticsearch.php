...
class Elasticsearch
{
    ...
    /**
     * @var \Amasty\ElasticSearch\Api\Data\Indexer\Structure\FiledMapperBuilderInterface
     */
    ...
    public function __construct(
        ...
        \Amasty\ElasticSearch\Api\Data\Indexer\Structure\FiledMapperBuilderInterface $filedMapperBuilder,
        ...
        $this->fieldMapperBuilder = $filedMapperBuilder;
        ...
        foreach ($fields as $field => $fieldInfo) {
            if ($fieldInfo['type'] === Product::ATTRIBUTE_TYPE_TEXT) {
                ...
                if ($this->config->getModuleConfig('catalog/long_tail')) {
                    $fieldInfo['analyzer'] = 'custom';
                }
            }

            $params['body'][$entityType]['properties'][$field] = $fieldInfo;
            $params['body'][$entityType]['dynamic_templates'] = $this->fieldMapperBuilder->build($field);
        }
