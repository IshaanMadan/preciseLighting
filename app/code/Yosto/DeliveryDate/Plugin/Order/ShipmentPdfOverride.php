...
/**
 * Class ShipmentPdfOverride
 * @package Yosto\DeliveryDate\Plugin\Order
 */
class ShipmentPdfOverride extends \Magento\Sales\Model\Order\Pdf\Shipment
{
    protected function insertOrder(&$page, $obj, $putOrderId = true)
    {
        ...
        if ($isActive) {
            if ($configData->getConfigData('yosto_opc_deliverydate/pdf/enable_shipment_pdf') == 1) {
