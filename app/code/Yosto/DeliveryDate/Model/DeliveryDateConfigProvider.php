 ...
 */
namespace Yosto\DeliveryDate\Model;
...
{
    const XPATH_FORMAT = 'yosto_opc_deliverydate/general/format';
    const XPATH_DISABLED = 'yosto_opc_deliverydate/general/disabled';
    const XPATH_HOURMIN = 'yosto_opc_deliverydate/general/hourMin';
    const XPATH_HOURMAX = 'yosto_opc_deliverydate/general/hourMax';
    const XPATH_ACTIVE = 'yosto_opc_deliverydate/general/active';
    ...
    public function getConfig()
    {
        ...
        $isActive = $this->scopeConfig->getValue(self::XPATH_ACTIVE, ScopeInterface::SCOPE_STORE, $store);
        $noday = 0;
        if($disabled == -1) {
            $noday = 1;
        }
