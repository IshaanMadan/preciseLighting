...
title=\"{$quickShopLabel}\">";
...

    {
		...
		if($this->_getRequest()->getServer('HTTP_REFERER')){
			...
			$data[\Magento\Framework\App\ActionInterface::PARAM_NAME_URL_ENCODED] = 
base64_encode($this->_getRequest()->getServer('HTTP_REFERER'));
