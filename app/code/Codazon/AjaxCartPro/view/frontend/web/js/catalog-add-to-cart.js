...
define([
    ...
    $.widget('mage.catalogAddToCart', {
        ...
        ajaxSubmit: function(form) {
			...
			$.ajax({
                ...
                success: function(res) {
					...
					jQuery('#minicart-wrapper').addClass('show-cart-quick');
					setTimeout(function(){ 
						jQuery('#minicart-wrapper').removeClass('show-cart-quick');
        ...
        var added_cart_label = document.getElementById("added_cart_label").value;
        var add_to_cart_label = document.getElementById("add_to_cart_label").value;
            ...
            if(!this.options.addToCartButtonTextAdded){
                ...
                this.options.addToCartButtonTextAdded = $t(added_cart_label);

            }

            if(!this.options.addToCartButtonTextDefault){

                this.options.addToCartButtonTextDefault = $t(add_to_cart_label);
