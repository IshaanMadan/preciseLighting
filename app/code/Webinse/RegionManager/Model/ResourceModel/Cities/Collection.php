...
​ * ​ ​ @license    ​ ​ http://opensource.org/licenses/OSL-3.0​ ​ The​ ​ Open​ ​ Software​ ​ License​ ​ 3.0
​ */
namespace Webinse\RegionManager\Model\ResourceModel\Cities;
...
class Collection extends AbstractCollection
{
    ...
    protected $_eventPrefix = 'webinse_regionmanager_cities_collection';

    protected $_eventObject = 'cities_collection';

    protected function _construct()
    {
        $this->_init('Webinse\RegionManager\Model\Cities', 'Webinse\RegionManager\Model\ResourceModel\Cities');
    }
